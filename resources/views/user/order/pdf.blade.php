    ...
    <table class="table table-bordered table-stripe">
      ...
      @endphp
        <tr>
          ...
          <td><span>Rp{{number_format($cart->price,3)}}</span></td>
        </tr>
      @endforeach
      </tbody>
      <tfoot>
        <tr>
          ...
          <th scope="col"> <span>Rp{{number_format($order->sub_total,3)}}</span></th>
        </tr>
      ...
      @endif --}}
        <tr>
          ...
          <th><span>Rp{{number_format($order->delivery_charge,3)}}</span></th>
        </tr>
        <tr>
          <th scope="col" class="empty"></th>
