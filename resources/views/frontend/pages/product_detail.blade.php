...
@endsection
@section('title','Blossom Fairys || PRODUCT DETAIL')
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @endphp
												<p class="price"><span class="discount">Rp{{number_format($after_discount,3)}}</span><s>Rp{{number_format($product_detail->price,3)}}</s> </p>
														...
														<div class="row">
															<div class="col-12">
																...
																<p class="text-center p-5">
																	Anda perlu <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Login</a> atau <a style="color:blue" href="{{route('register.form')}}">Register</a>
                                ...
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-price">
                                            ...
                                            @endphp
                                            <span class="old">Rp{{number_format($data->price,3)}}</span>
