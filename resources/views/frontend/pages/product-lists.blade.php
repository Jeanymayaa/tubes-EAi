...
@section('title','Blossom Fairys || PRODUCT PAGE')
                                    ...
                                    @foreach($recent_products as $product)
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
                                                ...
                                                @endphp
                                                <p class="price"><del class="text-muted">Rp{{number_format($product->price,3)}}</del>   Rp{{number_format($org,3)}}  </p>                                                
                                            </div>
                                        </div>
                                        <!-- End Single Post -->
                                    @endforeach
										...
										<div class="shop-shorter">
											...
											<div class="single-shorter">
												...
												<select class='sortBy' name='sortBy' onchange="this.form.submit();">
													...
													<option value="type" @if(!empty($_GET['sortBy']) && $_GET['sortBy']=='brand') selected @endif>Type</option>
												</select>
											</div>
										</div>
										<ul class="view-mode">
													...
													<div class="list-content">
														<div class="product-content">
															<div class="product-price">
																...
																@endphp
																<span>Rp{{number_format($after_discount,3)}}</span>
																<del>Rp{{number_format($product->price,3)}}</del>
															</div>
										...
										<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
											<div class="quickview-content">
												...
												@php
													$after_discount=($product->price-($product->price*$product->discount)/100);
												@endphp
												<h3><small><del class="text-muted">Rp{{number_format($product->price,3)}}</del></small>    Rp{{number_format($after_discount,3)}}  </h3>
